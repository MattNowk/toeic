const vocab = [
    ...
    { word: "Provided that", def: "À condition que", ex: "You can join the meeting provided that you arrive on time." },
    { word: "As long as", def: "Tant que", ex: "You can stay here as long as you respect the rules." },
    { word: "So that", def: "De sorte que", ex: "He saved money so that he could buy a car." },
    ...
    { word: "Furthermore", def: "En outre", ex: "The plan is safe; furthermore, it is cheap." },
    { word: "Including", def: "Y compris", ex: "The package includes breakfast and Wi‑Fi." },
    { word: "Namely", def: "À savoir", ex: "Two employees were dismissed, namely John and Lisa." },
    { word: "Notably", def: "Notamment", ex: "The city has many attractions, notably the museum." },
    ...
    { word: "However", def: "Cependant", ex: "The plan seemed good; however, it failed." },
    { word: "Nevertheless", def: "Néanmoins", ex: "The project was difficult; nevertheless, we finished it." },
    ...
    { word: "Although", def: "Bien que", ex: "Although it was late, they continued working." },
    { word: "Even though", def: "Même si", ex: "Even though it was cold, they went out." },
    { word: "Despite", def: "Malgré", ex: "Despite the difficulties, they succeeded." },
    { word: "In spite of", def: "En dépit de", ex: "In spite of the rain, the match was played." },
    { word: "Instead of", def: "Au lieu de", ex: "He decided to walk instead of driving." },
    { word: "Rather than", def: "Plutôt que", ex: "I prefer to walk rather than drive." },
    { word: "Besides", def: "En plus de", ex: "Besides English, she speaks French." },
    { word: "In addition to", def: "En plus de", ex: "In addition to the salary, there is a bonus." },
    { word: "Regarding", def: "Concernant", ex: "Regarding your request, we will respond soon." },
    { word: "Concerning", def: "Concernant", ex: "Concerning the meeting, we need a time." },
    { word: "According to", def: "Selon", ex: "According to the schedule, the train leaves at 9." },
    { word: "Prior to", def: "Avant", ex: "You must arrive prior to 9:00 a.m." },
    { word: "Subsequent to", def: "Après", ex: "Subsequent to the meeting, a decision was made." },
    { word: "Regardless of", def: "Indépendamment de", ex: "Sales increased regardless of the economic situation." },
    { word: "Including", def: "Y compris", ex: "The package includes airport transfer." },
    { word: "Namely", def: "À savoir", ex: "Three departments will be affected, namely HR, Marketing, and Sales." },
    { word: "Notably", def: "Notamment", ex: "The company has many offices, notably in Paris and London." },
    { word: "Mainly", def: "Principalement", ex: "The audience was mainly students." },
    { word: "Chiefly", def: "Surtout", ex: "The success was chiefly due to teamwork." },
    { word: "Primarily", def: "Essentiellement", ex: "The program is primarily for adults." },
    { word: "Currently", def: "Actuellement", ex: "The product is currently out of stock." },
    { word: "Eventually", def: "Finalement", ex: "He eventually agreed to the deal." },
    { word: "Previously", def: "Précédemment", ex: "Previously, I worked in sales." },
    { word: "Shortly", def: "Bientôt", ex: "The manager will contact you shortly." },
    { word: "Subsequently", def: "Par la suite", ex: "He resigned and subsequently started his own business." },
    { word: "Initially", def: "Initialement", ex: "Initially, I did not understand the instructions." },
    { word: "Seldom", def: "Rarement", ex: "He seldom arrives late." },
    { word: "Frequently", def: "Fréquemment", ex: "She frequently travels for business." },
    { word: "Occasionally", def: "Occasionnellement", ex: "They occasionally meet for lunch." },
    { word: "Regularly", def: "Régulièrement", ex: "He exercises regularly." },
    { word: "Consistently", def: "Consistamment", ex: "She works consistently hard." },
    { word: "Significantly", def: "Significativement", ex: "Sales increased significantly last year." },
    { word: "Substantially", def: "Substantiellement", ex: "The price of houses has risen substantially." },
...
{ word: "Available", def: "Disponible", ex: "Rooms are available this weekend." },
...
// ... (Garde tout ton tableau const vocab = [...] tel quel) ...
...
// 🐾 AJOUT : On appelle la fonction au démarrage pour afficher tous les mots !
renderCards(vocab);